...
use eArc\QueryLanguage\Interfaces\QueryResolverInterface;
...
class QueryResolver implements QueryResolverInterface
{
     ...
     */
    public function eval(QueryIndexServiceInterface $queryIndexService, QueryConjunction $queryConjunction): QueryResult
    {
        $queryConjunction;

        return new QueryResult($queryIndexService, $allowedDataIdentifiers, $primaryDataCategory, $values[0]);
    }
